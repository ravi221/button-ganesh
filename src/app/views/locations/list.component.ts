...
export class ListComponent implements OnInit {
    ...
    public sortFields = [{"Id": "id", "Name":"Id"}, {"Id": "Name", "Name":"Name"}, {"Id": "ShortCode", "Name":"Short code"}, {"Id": "Published", "Name":"Published"}, {"Id": "Ordering", "Name":"Order"},    	{ "Id": "CreatedAt", "Name": "Date Created"},
    ...
    itemsPerPageOptions = [5, 10, 20, 25, 50, 100, 250, 500];
  	...
  	ngOnInit() {
		this._titleService.setTitle(this._t('Locations.List'));
        this.globals = myGlobals;
        this.acl = this._auth.createACL('locations');
    ...
    getItems() {
        this.loading = true;
        let apiUrl = 'locations?limit=' + this.itemsPerPage + '&page=' + this.currentPage + '&sort=' + this.sortField + '|' + this.sortOrder; // URL to web API
    ...
    deleteItem(index: string) {
        ...
        this.loading = true;
        let apiUrl = 'locations/' + this.items[index].uid;
