...
export class ListComponent implements OnInit {
    ...
    public searchField = "";
    public searchFields = [
        { "Id": "Title", "Name": "Button Title"}, 
        { "Id": "Brand", "Name": "Brand"}, 
        { "Id": "BrandModel", "Name": "Model"}, 
    ...
    itemsPerPageOptions = [5, 10, 20, 25, 50, 100, 250, 500];
      ...
      ngOnInit() {
        this._titleService.setTitle(this._t('Items.List'));
        this.globals = myGlobals;
        this.acl = this._auth.createACL('items');
    ...
    getItems() {
        this.loading = true;
        let apiUrl = 'items?limit=' + this.itemsPerPage + '&page=' + this.currentPage + '&sort=' + this.sortField + '|' + this.sortOrder; // URL to web API
    ...
    deleteItem(index: string) {
        ...
        this.loading = true;
        let apiUrl = 'items/' + this.items[index].uid;
    ...
    getCategories(){
        this._netService.authGet('categories-public').subscribe(res => {this.categories = res; this.getItems()},error => {});
    }
}
